...
let automovil2 = new Automovil('Chevrolet', 'Camaro', 'Amarillo', 2018, 'Amanda Garcia');
let automovil3 = new Automovil('Toyota', 'Corolla', 'Blanco', 2021, 'thali gomez');
